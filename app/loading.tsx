  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: "var(--edu-bg)" }}>
      <div className="text-center">
        <div className="w-10 h-10 rounded-xl mx-auto mb-4 flex items-center justify-center animate-pulse"
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 w-32 rounded bg-gray-100 animate-pulse mx-auto" />
        </div>
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto px-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="rounded-xl border bg-white p-4 space-y-3 animate-pulse" style={{ borderColor: "var(--edu-border)" }}>
